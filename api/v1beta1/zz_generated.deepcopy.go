...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElfMachineNodeSpec) DeepCopyInto(out *ElfMachineNodeSpec) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ElfMachineNodeSpec.
func (in *ElfMachineNodeSpec) DeepCopy() *ElfMachineNodeSpec {
	if in == nil {
		return nil
	}
	out := new(ElfMachineNodeSpec)
	in.DeepCopyInto(out)
	return out
}
