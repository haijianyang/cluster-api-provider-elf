...
func IsUpdatingElfMachineResources(elfMachine *infrav1.ElfMachine) bool {
	if conditions.Has(elfMachine, infrav1.ResourceHotUpdatedCondition) &&
		conditions.IsFalse(elfMachine, infrav1.ResourceHotUpdatedCondition) {
		return true
	}
...
func NeedUpdateElfMachineResources(elfMachineTemplate *infrav1.ElfMachineTemplate, elfMachine *infrav1.ElfMachine) bool {
	if elfMachineTemplate.Spec.Template.Spec.NumCPUs > elfMachine.Spec.NumCPUs ||
		elfMachineTemplate.Spec.Template.Spec.NumCoresPerSocket > elfMachine.Spec.NumCoresPerSocket ||
