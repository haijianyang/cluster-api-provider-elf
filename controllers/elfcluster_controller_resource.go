...
func preflightCheckCondition2(kind string, obj conditions.Getter, condition clusterv1.ConditionType) error {
...
func (r *ElfClusterReconciler) reconcileCPResources(ctx *context.ClusterContext) (bool, error) {
	...
	if err := markElfMachineToBeUpdatedResources(nil, &elfMachineTemplate, toBeUpdatedElfMachine); err != nil {
		return false, err
	}
...
func markElfMachineToBeUpdatedResources2(ctx *context.ClusterContext, elfMachineTemplate *infrav1.ElfMachineTemplate, elfMachine *infrav1.ElfMachine) error {
